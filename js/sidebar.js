/* ============================================================
   ...
   includes Purchases; Settings group includes Manage Users).
...
const NAV_ITEMS = [
  ...
  { group: 'Settings', items: [
    /* Owner/manager only — populateUserChrome() in app-state.js hides this for staff. */
    { label: 'Manage Users', href: 'manage-users.html', aliases: [], icon: '<path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="17" y1="11" x2="23" y2="11"/>' },
